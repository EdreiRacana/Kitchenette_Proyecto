...
CAMPOS_DESCRIPCION = {
    ...
    "canal_venta":           "Canal donde se originó la venta (pos, shopify, amazon, mercadolibre, liverpool, coppel, web, whatsapp, phone)",
    "metodo_envio":          "Método de envío / entrega",
    "variante":              "Variante del producto (color, talla, presentación)",
    "subcategoria":          "Subcategoría interna del producto",
    "fecha_entrega":         "Fecha en que se entregó al cliente final",
    "cliente_nombre":        "Nombre del cliente al que se le vendió",
    "cliente_rfc":           "RFC del cliente — usado para conciliar contra el catálogo",
    "cliente_tipo":          "Tipo comercial del cliente (Contado, Crédito, Distribuidor, Empleado)",
    "tipo_relacion":         "Relación comercial (retail, wholesale, marketplace, consignment, chain_physical)",
    "sucursal":              "Sucursal / origen donde se realizó la venta",
    "iva_pct":               "IVA % de la partida (0, 8, 16)",
    "iva_importe":           "IVA en dinero de la partida",
    "descuento_pct":         "% de descuento aplicado a la partida",
    "descuento_importe":     "Descuento en dinero de la partida",
    "moneda":                "Moneda (MXN, USD, EUR). Si no se manda, se asume MXN",
    "tipo_cambio":           "Tipo de cambio hacia MXN cuando la moneda no es MXN",
    "notas_partida":         "Texto libre / observaciones a nivel partida",
    "costo_logistico":       "Costo de envío / logística de la cadena o marketplace",
