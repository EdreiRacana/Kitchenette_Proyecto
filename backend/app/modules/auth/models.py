...
class User(Base):
    ...
    # Foto de perfil como data URI (~50-100KB post-resize a 512px q=0.85).
    # Si es NULL, el resolver de /auth/me busca el Employee con el mismo email
    # y usa su foto como fallback.
