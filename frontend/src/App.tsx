...
const NAV_PERM = {
  dashboard: "dashboard", ventas: "sales", pos: "sales", forecast: "sales", retail: "sales", clientes: "customers", inventario: "inventory",
...
const STRINGS = {
  es: {
    ...
    nav: { dashboard: "Tablero", ventas: "Ventas / CRM", pos: "Punto de venta", forecast: "Forecast", retail: "Retail", clientes: "Clientes", inventario: "Inventario", finanzas: "Finanzas", contabilidad: "Contabilidad", rh: "RH / Nómina", reportes: "Reportes / BI", config: "Configuración" },
  ...
  en: {
    ...
    nav: { dashboard: "Dashboard", ventas: "Sales / CRM", pos: "Point of Sale", forecast: "Forecast", retail: "Retail", clientes: "Customers", inventario: "Inventory", finanzas: "Finance", contabilidad: "Accounting", rh: "HR / Payroll", reportes: "Reports / BI", config: "Settings" },
...
// Traducciones planas que consume features/sales/SalesCRM.tsx via makeTr(s).
// El modulo pide keys planas (sales_kpi_sold, returns_col_folio, ...) — cuando
// no las encuentra en `s`, cae al fallback (espanol). Aqui las proveemos.
const SALES_I18N: Record<"es" | "en", Record<string, string>> = {
  es: {
    ...
    sales_kpi_avg: "Ticket promedio",
    sales_kpi_filtered: "Indicadores calculados sobre los filtros activos",
    sales_search_placeholder: "Buscar folio, cliente o estado…",
    sales_all_docs: "Todos",
    sales_kind_order: "Pedidos",
    sales_kind_quote: "Cotizaciones",
    sales_filter_status: "Estado",
    sales_detail_payment: "Pago",
    sales_export: "Exportar",
    sales_new: "Nuevo",
    sales_no_customer: "Mostrador",
    sales_no_results: "Sin resultados",
    sales_no_results_hint: "Ajusta los filtros o crea un nuevo pedido.",
    sales_results: "resultados",
    sales_retry: "Reintentar",
    sales_load_error: "No se pudo conectar con el servidor. Los datos no se cargaron.",
    sales_need_rfc: "Agrega datos de facturación (RFC) al pedido para generar el CFDI.",
    sales_confirm_cancel: "¿Cancelar esta venta? Esta acción anula el pedido completo y no se puede revertir.",
    sales_returns_cancel_confirm: "¿Cancelar esta devolución? El stock y el saldo del cliente se revertirán.",
    sales_returns_cancel_error: "Error al cancelar la devolución",
    sales_col_folio: "Folio", sales_col_client: "Cliente", sales_col_date: "Fecha",
    sales_col_total: "Total", sales_col_status: "Estado", sales_col_payment: "Pago",
    sales_balance: "Saldo",
    returns_col_folio: "Folio", returns_col_client: "Cliente", returns_col_order: "Pedido",
    returns_col_date: "Fecha", returns_col_reason: "Motivo",
    returns_col_settlement: "Liquidación", returns_col_amount: "Monto", returns_col_status: "Estado",
    returns_cancel: "Cancelar", returns_no_results: "Sin devoluciones",
    returns_no_results_hint: "Las devoluciones registradas aparecerán aquí.",
  },
  en: {
    sales_kpi_sold: "Total sold",
    sales_kpi_pending_orders: "Pending orders",
    sales_kpi_pending_amount: "Receivable",
    sales_kpi_paid_rate: "Paid rate",
    sales_kpi_avg: "Avg. ticket",
    sales_kpi_filtered: "Indicators computed over active filters",
    sales_search_placeholder: "Search folio, customer or status…",
    sales_all_docs: "All",
    sales_kind_order: "Orders",
    sales_kind_quote: "Quotes",
    sales_filter_status: "Status",
    sales_detail_payment: "Payment",
    sales_export: "Export",
    sales_new: "New",
    sales_no_customer: "Walk-in",
    sales_no_results: "No results",
    sales_no_results_hint: "Adjust filters or create a new order.",
    sales_results: "results",
    sales_retry: "Retry",
    sales_load_error: "Could not connect to the server. Data was not loaded.",
    sales_need_rfc: "Add billing data (Tax ID) to the order to generate the CFDI.",
    sales_confirm_cancel: "Cancel this sale? This voids the entire order and cannot be undone.",
    sales_returns_cancel_confirm: "Cancel this return? Stock and customer balance will be reverted.",
    sales_returns_cancel_error: "Error cancelling the return",
    sales_col_folio: "Ref.", sales_col_client: "Customer", sales_col_date: "Date",
    sales_col_total: "Total", sales_col_status: "Status", sales_col_payment: "Payment",
    sales_balance: "Balance",
    returns_col_folio: "Ref.", returns_col_client: "Customer", returns_col_order: "Order",
    returns_col_date: "Date", returns_col_reason: "Reason",
    returns_col_settlement: "Settlement", returns_col_amount: "Amount", returns_col_status: "Status",
    returns_cancel: "Cancel", returns_no_results: "No returns",
    returns_no_results_hint: "Registered returns will appear here.",
  },
};

// Traducciones planas que consume features/forecast/ForecastModule.tsx via
// makeTr(s). Mismo patron que SALES_I18N: cuando la key no existe cae al
// fallback (espanol).
const FORECAST_I18N: Record<"es" | "en", Record<string, string>> = {
  es: {
    "forecast.title": "Forecast de ventas",
    "forecast.subtitle": "Proyección anual por cliente, producto y vendedor; contra venta real.",
    "forecast.newPlan": "Nuevo plan", "forecast.editPlan": "Editar plan",
    "forecast.editPlanTitle": "Editar plan de forecast",
    "forecast.deletePlan": "Eliminar plan",
    "forecast.pickPlan": "Elegir plan",
    "forecast.planName": "Nombre del plan",
    "forecast.year": "Año", "forecast.goalYear": "Meta anual", "forecast.realYear": "Venta real",
    "forecast.growth": "% Crecimiento", "forecast.growthLabel": "Crecimiento",
    "forecast.progress": "% de avance",
    "forecast.meta": "Meta", "forecast.real": "Real",
    "forecast.metaChartTitle": "Meta vs. venta real por mes",
    "forecast.concentradoTitle": "Concentrado",
    "forecast.byCustomer": "Cliente", "forecast.byProduct": "Producto", "forecast.bySalesperson": "Vendedor",
    "forecast.customer": "Cliente", "forecast.product": "Producto (SKU)", "forecast.salesperson": "Vendedor",
    "forecast.priceLabel": "Precio unitario",
    "forecast.notes": "Notas (opcional)",
    "forecast.notesPh": "Ej. Meta anual definida con dirección comercial",
    "forecast.freeService": "…o servicio de texto libre",
    "forecast.freeServicePh": "Ej. Instalación en obra",
    "forecast.status": "Estado",
    "forecast.status.active": "Activo", "forecast.status.closed": "Cerrado", "forecast.status.draft": "Borrador",
    "forecast.statusHelp": "Estados",
    "forecast.statusHelpBody": "Borrador = en preparación, no afecta el tablero. Activo = alimenta la meta del tablero. Cerrado = archivado, no se toma en cuenta.",
    "forecast.gridTitle": "Cuadrícula de forecast",
    "forecast.gridSub": "Edita las unidades directamente. Los totales y el % de avance se recalculan al guardar.",
    "forecast.gridFoot": "Plan",
    "forecast.addLine": "Agregar línea",
    "forecast.emptyTitle": "Crea tu primer plan de forecast",
    "forecast.emptyBody": "Define el año, meta de crecimiento y luego proyecta mes a mes por cliente/producto/vendedor. Puedes generar la línea base desde tu historial real.",
    "forecast.emptyLines": "El plan aún no tiene líneas.",
    "forecast.emptyLinesHint": "Agrega una manualmente o genera la línea base desde el historial real.",
    "forecast.noRollupRows": "Aún no hay líneas para concentrar.",
    "forecast.noCustomer": "Sin cliente", "forecast.noSalesperson": "—",
    "forecast.pickCustomer": "— Cliente —", "forecast.pickSalesperson": "— Vendedor —",
    "forecast.pickVariant": "— Producto del catálogo —",
    "forecast.baselineAdd": "Generar baseline",
    "forecast.baselineTitle": "Generar desde historial",
    "forecast.baselineHint": "Toma ventas reales del año anterior y aplica el % de crecimiento.",
    "forecast.baselineSellOutTitle": "Baseline por sell-out (retail)",
    "forecast.baselineWosTitle": "Baseline por WOS objetivo",
    "forecast.baselineGenerated": "Se generaron líneas desde el historial: ",
    "forecast.generate": "Generar",
    "forecast.import": "Cargar Excel/CSV",
    "forecast.importTitle": "Cargar forecast desde archivo",
    "forecast.importDone": "Importación completada",
    "forecast.linesCreated": "Líneas creadas", "forecast.linesSkipped": "Omitidas",
    "forecast.rowsWithError": "Filas con problema",
    "forecast.pickFile": "Selecciona un archivo .xlsx, .xlsm o .csv",
    "forecast.pickFileBtn": "Elegir archivo",
    "forecast.tplCsv": "Plantilla CSV", "forecast.tplXlsx": "Plantilla Excel (.xlsx)",
    "forecast.exportCsv": "Este plan · CSV", "forecast.exportXlsx": "Este plan · Excel (.xlsx)",
    "forecast.download": "Descargar",
    "forecast.upload": "Subir", "forecast.uploading": "Subiendo…",
    "forecast.save": "Guardar", "forecast.saving": "Guardando…",
    "forecast.saveChanges": "Guardar cambios",
    "forecast.create": "Crear", "forecast.creating": "Creando…",
    "forecast.cancel": "Cancelar", "forecast.close": "Cerrar",
    "forecast.delete": "Eliminar", "forecast.confirmDelete": "¿Eliminar esta línea?",
    "forecast.err.needName": "El plan necesita un nombre.",
    "forecast.err.needProduct": "Elige un producto o escribe un servicio.",
    "forecast.loadError": "No se pudieron cargar los planes.",
    "forecast.loading": "Cargando…",
    "forecast.units": "unidades", "forecast.monthlyUnits": "Unidades por mes (relleno)",
    "forecast.grandTotal": "Gran total", "forecast.rowLbl": "Fila",
    "forecast.col.customer": "Cliente", "forecast.col.product": "Producto / SKU",
    "forecast.col.salesperson": "Vendedor", "forecast.col.units": "Unid.",
    "forecast.col.price": "Precio", "forecast.col.total": "Total",
  },
  en: {
    "forecast.title": "Sales forecast",
    "forecast.subtitle": "Annual projection by customer, product and salesperson; against real sales.",
    "forecast.newPlan": "New plan", "forecast.editPlan": "Edit plan",
    "forecast.editPlanTitle": "Edit forecast plan",
    "forecast.deletePlan": "Delete plan",
    "forecast.pickPlan": "Choose plan",
    "forecast.planName": "Plan name",
    "forecast.year": "Year", "forecast.goalYear": "Annual goal", "forecast.realYear": "Actual sales",
    "forecast.growth": "% Growth", "forecast.growthLabel": "Growth",
    "forecast.progress": "% progress",
    "forecast.meta": "Goal", "forecast.real": "Actual",
    "forecast.metaChartTitle": "Goal vs. actual sales per month",
    "forecast.concentradoTitle": "Summary",
    "forecast.byCustomer": "Customer", "forecast.byProduct": "Product", "forecast.bySalesperson": "Salesperson",
    "forecast.customer": "Customer", "forecast.product": "Product (SKU)", "forecast.salesperson": "Salesperson",
    "forecast.priceLabel": "Unit price",
    "forecast.notes": "Notes (optional)",
    "forecast.notesPh": "e.g. Annual goal set with sales leadership",
    "forecast.freeService": "…or free-text service",
    "forecast.freeServicePh": "e.g. On-site installation",
    "forecast.status": "Status",
    "forecast.status.active": "Active", "forecast.status.closed": "Closed", "forecast.status.draft": "Draft",
    "forecast.statusHelp": "Statuses",
    "forecast.statusHelpBody": "Draft = in preparation, does not affect the dashboard. Active = feeds the dashboard goal. Closed = archived, ignored.",
    "forecast.gridTitle": "Forecast grid",
    "forecast.gridSub": "Edit units directly. Totals and % progress recalculate when you save.",
    "forecast.gridFoot": "Plan",
    "forecast.addLine": "Add line",
    "forecast.emptyTitle": "Create your first forecast plan",
    "forecast.emptyBody": "Set the year, growth target, then project month by month by customer/product/salesperson. You can generate the baseline from your real history.",
    "forecast.emptyLines": "The plan has no lines yet.",
    "forecast.emptyLinesHint": "Add one manually or generate the baseline from real history.",
    "forecast.noRollupRows": "No lines yet to summarize.",
    "forecast.noCustomer": "No customer", "forecast.noSalesperson": "—",
    "forecast.pickCustomer": "— Customer —", "forecast.pickSalesperson": "— Salesperson —",
    "forecast.pickVariant": "— Product from catalog —",
    "forecast.baselineAdd": "Generate baseline",
    "forecast.baselineTitle": "Generate from history",
    "forecast.baselineHint": "Takes last year's real sales and applies the growth %.",
    "forecast.baselineSellOutTitle": "Baseline by sell-out (retail)",
    "forecast.baselineWosTitle": "Baseline by target WOS",
    "forecast.baselineGenerated": "Lines generated from history: ",
    "forecast.generate": "Generate",
    "forecast.import": "Import Excel/CSV",
    "forecast.importTitle": "Import forecast from file",
    "forecast.importDone": "Import complete",
    "forecast.linesCreated": "Lines created", "forecast.linesSkipped": "Skipped",
    "forecast.rowsWithError": "Rows with issues",
    "forecast.pickFile": "Choose a .xlsx, .xlsm or .csv file",
    "forecast.pickFileBtn": "Choose file",
    "forecast.tplCsv": "CSV template", "forecast.tplXlsx": "Excel template (.xlsx)",
    "forecast.exportCsv": "This plan · CSV", "forecast.exportXlsx": "This plan · Excel (.xlsx)",
    "forecast.download": "Download",
    "forecast.upload": "Upload", "forecast.uploading": "Uploading…",
    "forecast.save": "Save", "forecast.saving": "Saving…",
    "forecast.saveChanges": "Save changes",
    "forecast.create": "Create", "forecast.creating": "Creating…",
    "forecast.cancel": "Cancel", "forecast.close": "Close",
    "forecast.delete": "Delete", "forecast.confirmDelete": "Delete this line?",
    "forecast.err.needName": "The plan needs a name.",
    "forecast.err.needProduct": "Pick a product or type a service.",
    "forecast.loadError": "Could not load plans.",
    "forecast.loading": "Loading…",
    "forecast.units": "units", "forecast.monthlyUnits": "Units per month (fill)",
    "forecast.grandTotal": "Grand total", "forecast.rowLbl": "Row",
    "forecast.col.customer": "Customer", "forecast.col.product": "Product / SKU",
    "forecast.col.salesperson": "Salesperson", "forecast.col.units": "Units",
    "forecast.col.price": "Price", "forecast.col.total": "Total",
  },
};
...
const MODULES = [
  ...
  { id: "retail", icon: Building2, live: true },
