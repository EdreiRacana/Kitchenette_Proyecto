...
const ES_EN_RAW: Record<string, string> = {
  ...
  // ─────── Customers — KPIs y labels ───────
  "Clientes": "Customers",
  "Activos": "Active",
  "Con crédito": "With credit",
  "Crédito otorgado": "Credit granted",
  "Programa de fidelidad": "Loyalty program",
  "Buscar nombre, RFC o No. de cliente…": "Search name, RFC or customer #…",
  "Sucursal": "Branch",

  // ─────── RH / Nomina ───────
  "Total empleados": "Total employees",
  "Costo nómina del mes": "Payroll cost (month)",
  "Costo nómina mes": "Payroll cost (month)",
  "En periodo de prueba": "In probation period",
  ...
  "Presupuesto": "Budget",
  "Ajuste ISR": "Annual ISR",
  "Cédulas IMSS": "IMSS statements",
  "Avisos IMSS": "IMSS notices",
  ...
  "Ventas totales (cobradas)": "Total sales (collected)",
  "Utilidad neta": "Net profit",
  "Ticket promedio": "Avg. ticket",
  "Margen neto": "Net margin",
  "Gastos totales": "Total expenses",
  "Valor inventario": "Inventory value",
  "Por cobrar (CXC)": "Receivables (AR)",
  "Por pagar (CXP)": "Payables (AP)",
  "Pendiente de cobro (período)": "Pending collection (period)",
  "Pendiente de cobro": "Pending collection",
  "Inventario (valor actual)": "Inventory (current value)",
  "Cotizaciones": "Quotes",
  "Cotizaciones generadas": "Quotes generated",
  "Pedidos confirmados": "Orders confirmed",
  "Pedidos pagados": "Orders paid",
  "Pedidos cerrados": "Orders closed",
  "Ventas totales": "Total sales",
  "Valor total": "Total value",
  "Unidades disponibles": "Available units",
  "Productos en stock bajo": "Products in low stock",
  ...
  // ─────── Config — labels comunes ───────
  "Empresa": "Company",
  "Miembros de la marca": "Brand members",
  "Usuarios (globales)": "Users (global)",
  "Roles y Permisos": "Roles & Permissions",
  "Aprobaciones": "Approvals",
  "Agentes / Comisiones": "Agents / Commissions",
  "Fiscal": "Tax",
