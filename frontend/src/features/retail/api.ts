...
export const retailApi = {
  ...
  pricing: (opts?: { channel_id?: number; days?: number }) =>
    api.get<import("./types").PricingResponse>("/retail/analytics/pricing", { params: opts }).then(r => r.data),
  priceHistory: (variant_id: number, opts?: { channel_id?: number; days?: number }) =>
    api.get<import("./types").PriceHistoryResponse>(`/retail/analytics/pricing/${variant_id}/history`, { params: opts }).then(r => r.data),
  trend: (opts?: {
  ...
  reports: {
    ...
    pricing: (params?: { channel_id?: number; days?: number }) =>
      api.get(`/retail/reports/pricing.xlsx`, { params, responseType: "blob" }).then(r => r.data as Blob),
